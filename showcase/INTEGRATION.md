# Adding pmOS to your personal site
...
**Replace** the “More coming soon” / “Another build in the works” block with the pmOS entry.
...
```html
<a href="https://mikelyngaas.github.io/pmos.html">pmOS</a>
...
```markdown
[pmOS](https://mikelyngaas.github.io/pmos.html)
...
## 3. Edit the copy on the pmOS page
...
Search for `[Replace with` to find every placeholder. The repo link is already set to `https://github.com/mikelyngaas/pmOS`; change it if your repo URL is different.

---

## 4. Back link

The “← Back” link on the pmOS page points to `https://mikelyngaas.github.io/`. If your site’s root URL is different, update it in `pmos.html`.
